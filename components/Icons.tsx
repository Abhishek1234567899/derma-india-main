...
const createHairLossIcon = (hairPath: React.ReactNode, lossPath?: React.ReactNode) => (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 100 100" {...props}>
        {/* Common head shapes */}
        <g fill="#f0d2b6">
            <circle cx="25" cy="30" r="15" /> {/* Front view head */}
            <path d="M15 45 C 15 55, 35 55, 35 45 Z" /> {/* Front view neck/shoulders */}
            <circle cx="70" cy="50" r="25" /> {/* Top view head */}
            <path d="M70 25 C 75 30, 80 40, 70 50 C 60 40, 65 30, 70 25" /> {/* Nose on top view */}
        </g>
        {/* Hair path */}
        <g fill="#333">{hairPath}</g>
        {/* Loss path */}
        {lossPath && <g fill="#ef4444">{lossPath}</g>}
    </svg>
);

export const MaleHairLoss1 = createHairLossIcon(
    <>
        <path d="M10,30 a15,15 0 0,1 30,0 v-5 a15,15 0 0,0 -30,0 z" />
        <circle cx="70" cy="50" r="25" />
    </>
);

export const MaleHairLoss2 = createHairLossIcon(
    <>
        <path d="M13,30 a12,12 0 0,1 24,0 v-7 a12,12 0 0,0 -24,0 z" />
        <path d="M45,50 a25,25 0 0,1 50,0 a25,25 0 0,1 -50,0 M55,32 a20,20 0 0,1 30,0" fill="none" stroke="#333" strokeWidth="16" strokeLinecap="round"/>
    </>
);

export const MaleHairLoss3 = createHairLossIcon(
    <>
        <path d="M15,30 a10,10 0 0,1 20,0 v-9 a10,10 0 0,0 -20,0 z" />
        <path d="M45,50 a25,25 0 0,1 50,0 a25,25 0 0,1 -50,0 M60,30 a15,15 0 0,1 20,0" fill="none" stroke="#333" strokeWidth="14" strokeLinecap="round"/>
    </>,
    <>
...
export const MaleHairLoss4 = createHairLossIcon(
    <>
        <path d="M18,30 a7,7 0 0,1 14,0 v-12 a7,7 0 0,0 -14,0 z" />
        <path d="M45,55 a25,25 0 0,1 50,0 v15 H45 Z" />
        <path d="M95,55 A25,25 0 0,1 70,75 A25,25 0 0,1 45,55" fill="none" stroke="#333" strokeWidth="10" />
    </>,
    <>
        <path d="M18,18 a7,7 0 0,1 14,0" />
        <path d="M70,25 A25,25 0 0,1 90,45 L80,55 L60,55 L50,45 A25,25 0 0,1 70,25 Z" />
    </>
);

export const MaleHairLoss5 = createHairLossIcon(
    <>
        <path d="M20,30 a5,5 0 0,1 10,0 v-15 a5,5 0 0,0 -10,0 z" />
        <path d="M48,60 a22,22 0 0,1 44,0 v12 H48 Z" />
    </>
    ,
    <>
        <path d="M20,15 a5,5 0 0,1 10,0" />
        <path d="M70,25 A25,25 0 0,1 92,50 L92,60 L48,60 L48,50 A25,25 0 0,1 70,25 Z" />
    </>
);

export const MaleHairLoss6 = createHairLossIcon(
    <>
        <path d="M10,35 a15,5 0 0,1 30,0 v5 H10 Z" />
        <path d="M50,65 a20,20 0 0,1 40,0 v10 H50 Z" />
    </>,
    <>
        <path d="M10,15 a15,15 0 0,1 30,0 v15 H10 Z" />
        <circle cx="70" cy="50" r="25" />
        <circle cx="70" cy="50" r="20" fill="#f0d2b6" />
    </>
);

export const MaleHairLossCoinPatch = createHairLossIcon(
    <>
        <path d="M10,30 a15,15 0 0,1 30,0 v-5 a15,15 0 0,0 -30,0 z" />
        <circle cx="70" cy="50" r="25" />
    </>,
...
export const MaleHairLossHeavyFall = createHairLossIcon(
    <>
        <path d="M10,30 a15,15 0 0,1 30,0 v-5 a15,15 0 0,0 -30,0 z" />
        <circle cx="70" cy="50" r="25" />
    </>,
    <>
        <path d="M5 25 q 5 -5 10 0" stroke="#333" strokeWidth="1.5" fill="none"/>
        <path d="M40 25 q 5 5 10 0" stroke="#333" strokeWidth="1.5" fill="none" />
        <path d="M5 50 q 5 -5 10 0" stroke="#333" strokeWidth="1.5" fill="none"/>
        <path d="M40 50 q 5 5 10 0" stroke="#333" strokeWidth="1.5" fill="none" />
        <path d="M50 80 q 5 -5 10 0" stroke="#333" strokeWidth="1.5" fill="none"/>
        <path d="M90 80 q 5 5 10 0" stroke="#333" strokeWidth="1.5" fill="none"/>
    </>
);
