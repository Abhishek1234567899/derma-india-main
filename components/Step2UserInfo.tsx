          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                  ...
                  <div className="w-28 h-28 sm:w-32 sm:h-32 my-2">
                      <img src="/male.png" alt="Male illustration" className="w-full h-full object-contain" />
                  </div>
              ...
              >
                  ...
                  <div className="w-28 h-28 sm:w-32 sm:h-32 my-2">
                      <img src="/female.png" alt="Female illustration" className="w-full h-full object-contain" />
                  </div>
